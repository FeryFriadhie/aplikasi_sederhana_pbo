...
public class panelTransaksiPenjualan extends dataForAllPanel {
    ...
    private void initComponents() {
        ...
        if (tabelPenjualan.getColumnModel().getColumnCount() > 0) {
            tabelPenjualan.getColumnModel().getColumn(6).setHeaderValue("Potongan");
        }
        ...
        txtSubPotongan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSubPotonganActionPerformed(evt);
            }
        });
        ...
        add(btnBatal, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 590, 80, -1));
    ...
    private void txtSubPotonganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSubPotonganActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtSubPotonganActionPerformed

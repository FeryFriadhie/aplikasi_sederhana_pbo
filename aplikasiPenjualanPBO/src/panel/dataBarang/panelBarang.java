...
public class panelBarang extends dataForAllPanel {
    ...
    private void initComponents() {
        ...
        comboBoxJenisBarang = new javax.swing.JComboBox<String>();
        ...
        comboBoxJenisBarang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kg", "Liter", "Buah", "Renteng", " " }));
